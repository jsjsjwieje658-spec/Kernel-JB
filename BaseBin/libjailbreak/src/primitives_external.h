...
struct kernel_primitives {
        ...
        // RootHide port (Relaxin upstream): added Relaxin extensions for the
        // trustcache_nokcall subsystem (kept at the tail for ABI stability).
        int (*protectedKwrite32)(uint64_t kaddr, uint32_t value);
