...
struct system_info {
        ...
        struct {
                ...
                char *rootPath;
                char *appIdentifier;
                // RootHide port (Relaxin upstream): added jbrand + palera1n + dyld_patch_enabled
                // for the Relaxin roothide infrastructure (roothider/common.m, recdhash.m use these).
                uint64_t jbrand;
                uint64_t palera1n;
        ...
        struct {
                ...
                // RootHide port (Relaxin upstream): added nchashtbl + nchashmask + launch_env_logging
                // + developer_mode_status + boot_os_tc_loaded + boot_app_tc_loaded for the Relaxin
                // roothide infrastructure (roothider/unsandbox1.m, unsandbox2.m, common.m use these).
                uint64_t nchashtbl;
                uint64_t nchashmask;
                uint64_t launch_env_logging;
                uint64_t developer_mode_status;
                uint64_t boot_os_tc_loaded;
                uint64_t boot_app_tc_loaded;
